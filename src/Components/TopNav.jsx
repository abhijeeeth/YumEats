    ...
    <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Yum 
                <span className='font-bold text-red-900'>Eats</span>
            </h1>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
            ...
            <input className='bg-transparent p-2 w-full focus:outline-none'  type='text' placeholder='Search for Meals'/>
        </div >
        ...
        >
          ...
          <h2 className=' text-2xl p-4 '>Yum <span className='text-red-900 font-semibold'>Eats</span></h2>
          <nav>
            <ul className=' flex flex-col p-4 text-gray-900'>
                ...
                <li className='text-xl py-4 flex'> 
                <MdOutlineFavorite size={25} className='mr-4 text-white bg-black rounded-full'/>Favourites
                </li>
                <li className='text-xl py-4 flex'> 
